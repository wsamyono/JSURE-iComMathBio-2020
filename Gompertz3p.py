...
def fopdt(y,t,x,alpha1, alpha2, beta1, gamma1):
    # arguments
    #  y      = output
    #  t      = time
...
def sim_model(x):
  ...
  #              y1 = odeint(fopdt,ym[i],ts,args=(uf,Km,taum,thetam))
        y1 = odeint(fopdt,ym[i],ts,args=(x,alpha1,alpha2, beta1, gamma1))
        ym[i+1] = y1[-1]
    return ym
...
print('alpha01: ' + str(x0[0]),'alpha02: ' + str(x0[1]), 'beta01: ' + str(x0[2])), 'and gamma01:' + str(x0[3])
...
print('alpha1: ' + str(x[0]),'alpha2: ' + str(x[1]), 'beta1: ' + str(x[2])), 'and gamma1:' + str(x0[3])
# print('taup: ' + str(x[1]))
