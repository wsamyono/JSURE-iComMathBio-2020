...
# Column 2 = input (u)
# Column 3 = output (yp)
data = np.loadtxt('dataandrewt011.txt',delimiter=',')
# u0 = data[0,1]
# yp0 = data[0,1]
# t = data[:,0].T - data[0,0]
t = data[:,0]
...
plt.title('Best Fit Model with Treatment - Exponential',loc='center')
plt.legend(loc='best')
#plt.subplot(2,1,2)
...
np.savetxt('datamd1t001.txt',data,delimiter=',')
plt.savefig('outputmodel13Kmt001.png',dpi=300,bbox_inches='tight')
plt.show()